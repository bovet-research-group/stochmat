"""
This module provides drop-in replacement functions in case cython is missing.
"""
import numpy as np
...
def sparse_stoch_from_full_csr(nz_rowcols,
                               Tf_data,
                               Tf_indices,
                               Tf_indptr,
                               diag_val):
...
def stoch_mat_add(size: int,  # big matrix size
                  Adata,
                  Aindices,
                  Aindptr,
                  Anz_rowcols,
...
def stoch_mat_sub(size: int,  # big matrix size
                  Adata,
                  Aindices,
                  Aindptr,
                  Anz_rowcols,
...
def get_submat_sum(Adata, Aindices, Aindptr, row_idx, col_idx) -> float:
...
def compute_delta_S_moveto(PTdata,
                           PTindices,
                           PTindptr,
                           PTcscdata,
                           PTcscindices,
...
def compute_delta_PT_moveout(PTdata,
                             PTindices,
                             PTindptr,
                             PTcscdata,
                             PTcscindices,
